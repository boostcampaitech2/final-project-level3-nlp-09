...
#     dag=dag,
# )
python_path = "/home/ubuntu/anaconda3/envs/torch/bin/python3"
train = BashOperator(
    task_id='train',
    depends_on_past=False,
    bash_command=python_path + ' /home/ubuntu/git/final-project-level3-nlp-09/airflow/sample_ml/train.py',
    retries=3,
    dag=dag,
)
serve_commands = python_path + """ /home/ubuntu/git/final-project-level3-nlp-09/app/myapp.py"""
# serve_commands = """
