...
from random_context import get_random_context_from_category
...
class ExtractivedQAMdoel:
    ...
    def set_context(self, category):
        self.context = get_random_context_from_category(self.dataset_path, category)

    def set_quesetion(self, question):
