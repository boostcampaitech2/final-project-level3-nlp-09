...
class QAInference:
    ...
    def load_trt_model(self):
        ...
        self.h_output = cuda.pagelocked_empty(tuple(self.engine_context.get_binding_shape(3)), dtype=np.float32)
        print(self.h_output)
...
if __name__ == "__main__":
    ...
    inf.set_context()
    inf.set_question(input("질문을 입력해주세요: ").strip())
    inf.set_dataset()
    inf.answers()